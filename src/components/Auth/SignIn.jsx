...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Force hash change and reload to trigger the new route
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 bg-gradient-to-br from-indigo-600 to-indigo-800 relative">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-12 text-white">
          <h2 className="text-4xl font-bold mb-6">Adbot.ai</h2>
          <p className="text-xl opacity-90">
            Create stunning ads in minutes with AI-powered technology
          </p>
        </div>
      </div>
    </div>
